...
export const QueryGranterGrantsRequest = {
  encode(message: QueryGranterGrantsRequest, writer: Writer = Writer.create()): Writer {
    if (message.granter !== '') {
      writer.uint32(10).string(message.granter)
    }
    if (message.pagination !== undefined) {
...
export const QueryGranterGrantsResponse = {
  encode(message: QueryGranterGrantsResponse, writer: Writer = Writer.create()): Writer {
    for (const v of message.grants) {
...
export const QueryGranteeGrantsRequest = {
  encode(message: QueryGranteeGrantsRequest, writer: Writer = Writer.create()): Writer {
    if (message.grantee !== '') {
...
export const QueryGranteeGrantsResponse = {
  encode(message: QueryGranteeGrantsResponse, writer: Writer = Writer.create()): Writer {
    for (const v of message.grants) {
      GrantAuthorization.encode(v!, writer.uint32(10).fork()).ldelim()
    }
    if (message.pagination !== undefined) {
